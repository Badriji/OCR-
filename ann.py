...
detection1 = 'C:\\Users\\User\\Desktop\\test\\codes\\detection-images\\detection-1.jpg'
...
for k, v in predictCount.items():
	...
	if k == 't':
		resImg = 'C:\\Users\\User\\Desktop\\test\\codes\\detection-images\\t.jpg'
		img = cv2.imread(resImg,0)
		cv2.imshow("Detected Image, T", img)

	if k == 'e':
		resImg = 'C:\\Users\\User\\Desktop\\test\\codes\\detection-images\\e.jpg'
		img = cv2.imread(resImg,0)
		cv2.imshow("Detected Image, E", img)

	if k == 's':
		resImg = 'C:\\Users\\User\\Desktop\\test\\codes\\detection-images\\s.jpg'
		img = cv2.imread(resImg,0)
